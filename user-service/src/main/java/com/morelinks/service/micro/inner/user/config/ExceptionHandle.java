package com.morelinks.service.micro.inner.user.config;
...
@RestController
@ControllerAdvice(basePackages = {"com.morelinks.service.micro.inner.user.controller"})
public class ExceptionHandle {
	private Logger logger = LoggerFactory.getLogger(ExceptionHandle.class);
	@ExceptionHandler(value = Exception.class)
	@ResponseBody
	public ReturnValue handle(Exception e) {
		logger.error("ExceptionHandle start",e);
...
//			}
		...
		logger.error("ExceptionHandle end");
		return ret;
	}
}
